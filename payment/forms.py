...
class PaymentForm(forms.Form):
    ...
    card_city = forms.CharField(
        label="",
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Card City"}
        ),
        required=True,
    )
    card_state = forms.CharField(
        label="",
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Card State"}
        ),
        required=False,
    )
    card_zipcode = forms.CharField(
        label="",
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Card Zipcode"}
        ),
        required=False,
    )
    card_country = forms.CharField(
        label="",
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Card Country"}
        ),
        required=True,
    )
